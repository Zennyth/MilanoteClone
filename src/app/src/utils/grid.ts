...
export function isIn(r1: Shape, r2: Shape): boolean {
	return r1.position.x <= r2.position.x && r1.position.y <= r2.position.y && r1.position.x + r1.size.x >= r2.position.x + r2.size.x && r1.position.y + r1.size.y >= r2.position.y + r2.size.y
}